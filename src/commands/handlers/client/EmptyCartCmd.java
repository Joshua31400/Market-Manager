...
public class EmptyCartCmd extends CommandHandler {
    ...
    public void execute() {
        ...
        if (!success) {
            System.out.println(Colors.error("Failed to empty your cart. Please try again later."));
            System.out.println();
        }
        System.out.println(Colors.success("Your cart has been emptied."));
        System.out.println();
    }
    ...
    private boolean validateArgs() {
        if (!args.isEmpty()) {
            System.out.println(Colors.warning("Usage: emptycart"));
            System.out.println();
            return false;
        }
        return true;
